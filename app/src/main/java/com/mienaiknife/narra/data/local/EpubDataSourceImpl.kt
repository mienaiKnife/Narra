...
class EpubDataSourceImpl
@Inject
constructor(
    private val imageDataSource: ImageDataSource,
) : EpubDataSource {
    override suspend fun parseEpub(
        ...
        return try {
            ...
            val author =
                book.metadata.authors
                    .firstOrNull()
                    ?.let { "${it.firstname} ${it.lastname}".trim() } ?: "Unknown Author"
            ...
            val articles =
                coroutineScope {
                    spineReferences
                        .mapIndexed { index, spineReference ->
