...
- [x] **Widget deep link ignored.** `MainActivity.kt:90-96` `onNewIntent`; `ui/widget/NarraWidget.kt:156-161`.
...
- [x] **Widget image cache file collisions/eviction.** `ui/widget/WidgetImageWorker.kt:56,66-68`.
...
- [x] Add code-coverage reporting (JaCoCo/Kover) if coverage goals are to be enforced.
